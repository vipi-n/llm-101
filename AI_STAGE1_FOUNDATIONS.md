...
[ few-shot examples    ]  ← optional: example inputs/outputs
[ retrieved documents  ]  ← optional: RAG content
[ chat history         ]  ← previous user/assistant turns
[ current user message ]  ← what the user just typed
[ model's reply        ]  ← what's being generated right now
```
